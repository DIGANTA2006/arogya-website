...
function getBotAnswer(question: string) {
  ...
  return "I can help with appointments, timing, services, online consultation, speech therapy, hearing test, hearing aid support, fees and location. For medical advice, please book a consultation.";
}
