      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex h-14 items-center justify-between sm:h-16 lg:h-20">
          ...
          <div className="flex items-center gap-3">
            <a
              href="/portal"
              className="hidden rounded-full bg-slate-900 px-5 py-2.5 text-sm font-bold text-white shadow-md transition-all duration-200 hover:scale-105 hover:bg-slate-800 sm:inline-flex"
            >
              Portal Login
            </a>
